...
class BaseAssistant:
    ...
    def getAllUfoFonts(self, parentPath=None):
    ...
    def getCurrentGlyph(self, layerName=None):
...
class AssistantController(BaseAssistant, WindowController):
    ...
    ADD_GLOBAL_BUTTONS = True # Let baseAssistant add global buttons under the UI of the parts.
